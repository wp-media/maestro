...
## Scope
Files in the project's PHP source and template directories that read superglobals or
external input.
...
## Examples
```php
check_admin_referer( 'plugin_settings_page' );
...
## Verification
- Run the project's PHPCS check command (see `composer.json`) and confirm there are no:
