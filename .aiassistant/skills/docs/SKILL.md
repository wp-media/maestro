...
- For new capabilities, add them to `.aiassistant/config/repo-map.json` under `ai.capabilities` so the `wordpress-compliance` skill and PHPCS do not flag future uses.
