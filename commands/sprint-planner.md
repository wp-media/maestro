...
name: sprint-planner
description: >
  Generate a sprint shortlist with story point estimation and capacity planning for the current project.

  Use this skill whenever you need to:
  - Plan a 2-week sprint with realistic team capacity constraints
  - Quickly estimate effort on unstarted issues without full grooming analysis
  - Create a balanced shortlist across bugs, features, and tech debt
  - Generate a shareable HTML report for sprint planning meetings

  The skill asks for team size (default: 2 developers) and optionally a target milestone, then fetches
  open unassigned issues from the project repo. It estimates story points through lightweight scope
  analysis, builds a prioritized shortlist to fit the sprint capacity, and outputs an interactive HTML
  report to {TEMP_ROOT}/sprint/. The entire process takes 2–3 minutes.
---
...
<body>
  <div class="container">
    ...
    <div class="footer">
      ...
      Repo: {REPO} &nbsp;·&nbsp; Generated by Maestro sprint-planner
    </div>
  </div>
</body>
</html>
