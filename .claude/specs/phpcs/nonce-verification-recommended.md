...
## Scope
Files in the project's PHP source directories that emit the warning
...
// Handler
check_admin_referer( 'plugin_action_name', 'plugin_nonce' );
...
if ( $nonce && wp_verify_nonce( $nonce, 'plugin_list_filter' ) ) {
